...
#define _LANGUAGE_RU_H_
    ...
    #define RU_SOUND                  "Sound"
    #define RU_TOUCH_SOUND            "Touch sounds"
    #define RU_TOAST_SOUND            "Toast Notifications"
    #define RU_ALERT_SOUND            "Popups and Alerts"
    ...
    #define RU_ACK_NOTIFICATION       "ACK notification style"
